...
The current implementation should be read as an incremental realization of the existing contracts:

- LPS remains the factual source of Positions, Transactions, valuation observations, and accepted Purpose attribution.
- LFS remains responsible for reviewed formation intent and TARGET inputs.
- LTS consumes those projections to classify and analyse feasible transitions.
