...
def test_requirement_within_observed_upper_terrain_is_plausible():
    purpose = Purpose(name="Retirement", capital=100_000, desired_target=150_000, horizon_years=5)
...
def test_requirement_beyond_observed_upper_terrain_is_not_called_plausible():
    purpose = Purpose(name="Retirement", capital=100_000, desired_target=200_000, horizon_years=5)
...
def test_longer_purpose_uses_longest_supported_horizon_not_beyond_it():
    purpose = Purpose(name="Retirement", capital=100_000, desired_target=200_000, horizon_years=8)
    fp = SimpleNamespace(elevation=SimpleNamespace(
...
def test_short_purpose_without_supported_observation_is_insufficient():
    purpose = Purpose(name="Goal", capital=100_000, desired_target=110_000, horizon_years=2)
