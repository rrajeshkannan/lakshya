"""Persistence for LPS transaction evidence."""
...
def write_transactions(path: Path, transactions: list[Transaction]) -> None:
    """Write the family-wide normalized transaction collection."""
...
__all__ = ["TRANSACTION_FIELDS", "write_transactions", "read_transactions"]
